...
namespace AccountService.Infrastructure
{
    ...
    {
        new Owner { Id = Guid.Parse("11111111-1111-1111-1111-111111111111"), FirstName = "Иван", LastName = "Иванов", FatherName = "Иванович" },
        new Owner { Id = Guid.Parse("22222222-2222-2222-2222-222222222222"), FirstName = "Мария", LastName = "Петрова", FatherName = "Сергеевна" }
    };
